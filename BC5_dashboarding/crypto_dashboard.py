...
#price cannot be retreived anymore and its hardcoded as 0 
#since yfinance's latest release does not provide regularMarketPrice key or equivalent 
...
def sentiment_display(tickerSymbol):
    n_tweets = st.number_input("Select Number of tweets to analyse",min_value=100, max_value=1500)
